...
const SearchParty = () => {
  ...
  return (
    <section className="py-10 bg-[#FFF5E6]">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-[#1A4A4A] mb-6">Your Search Party</h2>
          ...
          {isLoading ? (
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mb-8">
              <h3 className="text-xl font-semibold text-[#1A4A4A] mb-4">No Search Parties Yet</h3>
              <p className="text-[#1A4A4A] mb-6">
                You don't have any search parties. Create one to start collaborating with friends and roommates.
              </p>
            </div>
          )}
          
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-[#1A4A4A] mb-4">Create a Search Party</h3>
            <p className="text-[#1A4A4A] mb-6">
              Invite friends and roommates to collaborate on your apartment hunt. Share and save listings together.
            </p>
