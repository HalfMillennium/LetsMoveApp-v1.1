      ...
      <div className="container mx-auto px-4">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-10">
            <h3 className="text-xl font-semibold text-[#1A4A4A] mb-2">No apartments found</h3>
            <p className="text-[#1A4A4A]/70">Try adjusting your filters or search for a different area.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
