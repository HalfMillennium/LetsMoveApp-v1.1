    ...
    <div className="flex flex-1">
      <div className="w-full flex flex-wrap gap-3 items-center">
        ...
        {isMobile ? (
          ...
          <div className="flex items-center border backdrop-blur-sm rounded-xl p-2 flex-grow transition-all duration-300 ease-in-out">
            ...
            <div className="relative overflow-hidden transition-all duration-300 ease-in-out">
              ...
              >
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-[#1A4A4A] ml-1 h-8 text-xs rounded-xl items-center whitespace-nowrap"
                  onClick={() => {
                    clearAllFilters();
                    if (filterBySearchParty) {
