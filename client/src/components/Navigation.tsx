...
export const Navigation = ({ darkMode = false, buttonStyle = "pill" }: NavigationProps) => {
  ...
  const pillStyle = darkMode 
    ? "bg-[#F9A775] text-[#0D2436] hover:bg-opacity-90 rounded-full py-3 px-8 text-sm font-medium transition-colors"
    : "bg-[#FFF5E6] rounded-full py-3 px-8 text-sm font-medium";
