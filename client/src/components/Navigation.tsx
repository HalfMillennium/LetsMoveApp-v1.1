...
export const Navigation = ({
  ...
  const pillStyle = darkMode
    ? "bg-[#FFF9F2] text-[#0D2436] hover:bg-opacity-90 rounded-xl py-3 px-8 text-sm font-medium transition-colors"
    : "bg-[#FFF9F2] rounded-xl py-3 px-8 text-sm font-medium";
