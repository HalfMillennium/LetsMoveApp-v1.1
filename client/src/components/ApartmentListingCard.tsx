...
interface ApartmentListingCardProps {
  ...
  handleApartmentSelect: (index: number) => void;
  index: number;
}

export const ApartmentListingCard: React.FC<ApartmentListingCardProps> = ({apartment, apartmentRefs, handleApartmentSelect, index}) => {
