      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="mb-6 md:mb-0">
            <h2 className="text-[#E9927E] text-2xl font-semibold mb-4">letsmove</h2>
            <p className="text-[#C9DAD0]/80 max-w-xs">
              Find your perfect apartment with personalized, hyper-local search results.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-[#C9DAD0]/80 mb-3">Get the latest listings in your area</p>
              <form className="flex" onSubmit={handleSubscribe}>
                <Input
                  type="email"
                  name="email"
                  placeholder="Your email"
                  className="px-3 py-2 rounded-l-lg w-full focus:outline-none text-[#1A4A4A]"
                />
                <Button type="submit" className="bg-[#E9927E] text-white px-4 py-2 rounded-r-lg hover:bg-[#E9927E]/90">
        ...
        <div className="mt-8 pt-8 border-t border-[#C9DAD0]/20 flex flex-col md:flex-row justify-between items-center">
          <p className="text-[#C9DAD0]/60 text-sm">© 2023 letsmove. All rights reserved.</p>
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="#" className="text-[#C9DAD0]/80 hover:text-white transition-colors">
